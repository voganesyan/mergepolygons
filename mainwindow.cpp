...
{
    newAct = new QAction(tr("&Новый полигон"), this);
    newAct->setShortcuts(QKeySequence::New);
    connect(newAct, SIGNAL(triggered()), this, SLOT(newPolygon()));

    openFileAct = new QAction(tr("из файла"), this);
    ...
    openDbAct = new QAction(tr("из базы данных"), this);
    connect(openDbAct, SIGNAL(triggered()), this, SLOT(openDbPolygon()));

    saveDbAct = new QAction(tr("в базу данных"), this);
